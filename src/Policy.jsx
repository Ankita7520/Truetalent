    ...
    return(
        <div>
            ...
            <h3>Terms of Use & Privacy Policy</h3>
               ...
               <p className="blog"> Note: All references to "we", "us", "our website", or TrueTalent relate to the website www.TrueTalent.io (the "Website" or "Sites"). TrueTalent provides links to the websites of several other businesses (clients &partners) to whom this policy does not apply.</p><br></br>
                
<p className="blog">TrueTalent is dedicated to protecting the privacy of your Personally Identifiable Information ("PII"). Your loyalty as a job seeker, client, or visitor is important to us, and we trust that our concerns for your privacy, as outlined in this policy (the "Privacy Policy" or "Policy"), indicate our dedication to making your experience with TrueTalent rewarding.</p><br></br>
<p className="blog">This Privacy Statement regulates your interactions with the Sites and your use of our online services (collectively, the "Services"). We do not disclose personal information about our users and visitors without their consent, except as specified in our Privacy Policy, our Terms of Service Agreement, and other published guidelines. This Privacy Statement only applies to the information collected by the websites and mobile apps that provide a link to this Privacy Statement. Consequently, we urge you to check the whole Privacy Statement. Please choose one of the links below to examine the corresponding section.</p><br></br>
<p className="blog">1. The information we acquire<br></br>
